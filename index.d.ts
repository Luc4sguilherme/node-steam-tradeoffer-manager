...
declare class TradeOfferManager extends EventEmitter {
     ...
     * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/Polling|polls}. If `-1`, timed polling is
     * disabled.
     *
     ...
     * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/Polling|polling}, so it will only work as
     ...
     * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/TradeOfferManager#polldata|pollData}
     */
    pollData: any;

    /**
     * A read-only property containing your account's API key once the callback of
     * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/TradeOfferManager#setcookiescookies-familyviewpin-callback|setCookies}
    ...
    on<T extends keyof TradeOfferManager.EventListener>(event: T, listener: TradeOfferManager.EventListener[T]): this;
    ...
    /**
     * Get the contents of your own inventory context.
     *
    ...
    getInventoryContents(
        ...
        callback: (
            err: Error | null,
            inventory: TradeOfferManager.EconItem[],
            currencies: TradeOfferManager.EconItem[],
        ) => void,
    ): void;
     ...
     *
     * @param sid - The user's SteamID as a SteamID object or a string which can parse into one
     * @param appid - The Steam application ID of the game for which you want an inventory
     * @param contextid - The ID of the `context` within the game you want to retrieve
     * @param tradableOnly - True to get only tradable items and currencies
     * @param callback
     ...
     */
    createOffer(partner: SteamID | string, token?: string): TradeOfferManager.TradeOffer;
     ...
     * @param callback
     */
    getOffer(id: number | string, callback: (err: Error | null, offer: TradeOfferManager.TradeOffer) => void): void;
...
declare namespace TradeOfferManager {
    ...
    interface EventListener {
         ...
         * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/Polling|polling} is enabled.
         *
         ...
         * `node-steam-tradeoffer-manager`(i.e. it's not in the poll data, so this will emit for all sent offers on
         ...
         *   {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/blob/master/resources/ETradeOfferState.js|ETradeOfferState}
         *   of the offer.
         */
        receivedOfferChanged: (offer: TradeOffer, oldState: ETradeOfferState) => void;
         ...
         * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/Real-Time-Trades|real-time trades}
         ...
         * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/Polling|Polling} page for more information.
         *
    ...
    interface Options {
        /**
         * See
         * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/TradeOfferManager#steam-integration|Steam Integration}
         * below.
         */
        steam?: any;

        /**
         * A {@link https://github.com/DoctorMcKay/node-steamcommunity|node-steamcommunity} instance of v3.19.1 or later
         ...
         * {@link https://steamcommunity.com/dev/apikey|Steam Web API key}. Defaults to `localhost`.
         */
        domain?: string;
        ...
        /**
         * The time, in milliseconds, between
         * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/Polling|polls}. If `-1`, timed
         * polling is disabled.
         *
         * Minimum `1000`, default `30000` (30 seconds).
         */
         ...
         *
         * Note that this check is performed on
         * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/Polling|polling}, so it will only
         ...
         * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/wiki/TradeOfferManager#storage|custom storage engine}
         * you wish to use). If not, then once asset descriptions are purged from memory they will need to be
         ...
         * {@link https://github.com/DoctorMcKay/node-steam-user#datadirectory|in the same form as node-steam-user}. You
         * can set this to null to disable all data persistence to disk.
         */
    ...
    abstract class TradeOffer {
        constructor(manager: TradeOfferManager, partner: SteamID | string, token?: string);
         ...
         * {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/blob/master/resources/EConfirmationMethod.js|EConfirmationMethod}
         */
        ...
        getPartnerInventoryContents(
            appid: number,
            contextid: number,
            callback: (err: Error | null, inventory: EconItem[], currencies: EconItem[]) => void,
        ): void;
         ...
         */
        addMyItems(items: EconItem[]): boolean;
         ...
         * @param items - An array of item objects.
         */
        addTheirItems(items: EconItem[]): boolean;
         ...
         */
        getReceivedItems(getActions: boolean, callback: (err: Error | null, items: EconItem[]) => void): void;
         ...
         *   - `items` - An array of `EconItem` objects that you received.
         */
        getReceivedItems(callback: (err: Error | null, items: EconItem[]) => void): void;
         ...
         *       {@link https://github.com/DoctorMcKay/node-steam-tradeoffer-manager/blob/master/resources/ETradeStatus.js|ETradeStatus}
         *       enum, which is accessible via `TradeOfferManager.ETradeStatus`.
         ...
         */
        getUserDetails(callback: (err: Error | null, me: UserData, them: UserData) => void): void;
